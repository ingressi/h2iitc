# How to iitc
<img src="cc_by.svg" />
인그레스를 원활하게 도와주는 도구앱인 iitc의 기초적인 활용법을 소개하는 문서.  
...
(Show zoom control 기능은 줌슬라이드 상하단에 + - 버튼을 나오게 하고, 
Press back twice 기능은 back 버튼 실수로 앱종료되는 것을 방지하고, 
Persistent 줌레벨 기능은 선택한 지도 축척이 함부로 변경되지 않게 함)  

이 중에 하위 메뉴가 많아서 별도로 설명하게 되는 메뉴 2가지는 
"IITC Plugins" 메뉴와 "Advanced settings" 메뉴인데, 
...
가장 길고 많은 내용을 가진 Plugins 메뉴에 들어가보면 아래와 같습니다.  
<img src="IITC_10.jpg" />  
